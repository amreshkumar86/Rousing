;(function () {
  ...
  blankCtrl.$inject = [ '$rootScope','$scope','blankServices','$location','toaster'];
  ...
  function blankCtrl( $rootScope,$scope,blankServices,$location,toaster ) {
    // [1]
    ...
    { 
    	blankServices.getUserDetais().then( function mySucces(data){	   
 		  ...
 		  $rootScope.name  = $scope.dataValue.firstname + " " + $scope.dataValue.lastname;	  
